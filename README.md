...
## 백엔드
 ...
 장애는 개발자가 해결하지 않아도 복구될 수 있어야 합니다. 접속자가 급격하게 늘어나더라도 가용 범위 내에서는 자동으로 서버가 증설될 수 있어야 하고, 이중화(HA) 같은 방법으로 서버가 다운되더라도 수분 이내로 standby 서버가 똑같은 기능을 수행해야 하죠. 백엔드 개발자로서 이런 모든 것들을 해낼 수 있겠다면 좋겠지만, 방향성을 알고 있다는 것만으로도 신입 개발자로서는 충분할 수 있습니다. 
